...
<template>
    ...
    <div class="flex flex-col w-full items-center justify-between bg-black">
        ...
        >
                ...
                >
                    <span class="text-white text-lg leading-[100%]">
                        ...
                        <span class="text-white/30"
                            >(Pending integration with live $VOR token)</span
                        >
                    </span>
                </button>
                <div
                    ...
                    <div class="flex flex-col gap-3 items-center w-full">
                        ...
                        >
                            ...
                            <div class="flex w-full max-w-[256px]">
                                ...
                                >
                                    +{{ address.reward ? address.reward : "0" }} $VOR
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex gap-6 items-center w-full" data-aos="fade-up" data-aos-delay="100">
                <div
                ...
                >
                    ...
                    <span
                        class="text-white/50 text-lg font-light leading-[115%]"
                    >
                        Extra bonuses may apply for detecting wallet groups or
                        submitting early reports.
                    </span>
                    <span
                        class="text-white/50 text-lg font-light leading-[115%]"
                    >
                        False or spam reports are not rewarded (systematic abuse
                    ...
                    <span
                        class="text-white/50 text-lg font-light leading-[115%]"
                    >
                        Rewards are funded by Pump.fun trading fee sharing and
                        our continuous buyback program.
                    </span>
                </div>
                <div class="flex relative p-6 w-full max-w-[852px] overflow-hidden">
                    <div class="flex flex-col gap-[12px] z-50 max-w-[365px]">
                        <span
