...
// Слушаем изменения пропса isVisible
watch(() => props.isVisible, (newVal) => {
    isVisible.value = newVal;
    if (newVal) {
        setTimeout(() => {
...
<template>
    <transition
        ...
        enter-from-class="opacity-0 scale-90 translate-x-full"
        enter-to-class="opacity-100 scale-100 translate-x-0"
        leave-active-class="transition-all duration-300 ease-in transform"
        leave-from-class="opacity-100 scale-100 translate-x-0"
        leave-to-class="opacity-0 scale-90 translate-x-full"
    >
        <div
            v-if="isVisible"
            :class="[
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    class="flex-shrink-0 ml-2 text-white/70 hover:text-white transition-colors duration-200 hover:scale-110 transform"
                >
